...
export const CreateNewUser = (email, password, userName, role, avatar) => {
  ...
  return getAxios.post("/api/v1/participant", data)
}

export const getAllUser = () => {
  return getAxios.get("/api/v1/participant/all")
}

export const getUserWithPaginate = (page, limit) => {
  return getAxios.get(`/api/v1/participant?page=${page}&limit=${limit}`)
}
...
export const putUpdateUser = (id, userName, role, avatar) => {
  ...
  return getAxios.put("/api/v1/participant", dataUpdate)
}

export const deleteUser = (userId) => {
  return getAxios.delete("/api/v1/participant", { data: { id: userId } })
}

export const getQuizByUser = () => {
  return getAxios.get("/api/v1/quiz-by-participant")
}

export const getDataOverView = () => {
  return getAxios.get("/api/v1/overview")
}

export const getUserHistory = () => {
  return getAxios.get("/api/v1/history")
}

// Login + Signup
export const postLogin = (email, password, delay) => {
  return getAxios.post("/api/v1/login", {
    email,
    password,
...
export const postSignup = (email, password, username) => {
  return getAxios.post("/api/v1/register", {
    email,
    password,
    username,
  })
...
export const postLogout = (email, refresh_token) => {
  return getAxios.post("/api/v1/logout", {
    email,
    refresh_token,
  })
}
...
export const postRefreshToken = (email, refresh_token) => {
  return getAxios.post("/api/v1/refresh-token", {
    email,
    refresh_token,
  })
}
...
export const postChangePassword = (current_password, new_password) => {
  return getAxios.post("/api/v1/change-password", {
    current_password,
    new_password,
  })
}
...
export const getDataQuiz = (id) => {
  return getAxios.get(`/api/v1/questions-by-quiz?quizId=${id}`)
}

export const postSubmitQuiz = (data) => {
  return getAxios.post("/api/v1/quiz-submit", { ...data })
}
...
export const createNewQuiz = (description, name, difficulty, quizImage) => {
  ...
  return getAxios.post("/api/v1/quiz", data)
}
export const postUpdateProfile = (username, userImage) => {
  const dataUpdate = new FormData()
  dataUpdate.append("username", username)
  dataUpdate.append("userImage", userImage)
  return getAxios.post("/api/v1/profile", dataUpdate)
}

export const getAllQuiz = () => {
  return getAxios.get("/api/v1/quiz/all")
}

export const deleteQuizForAdmin = (id) => {
  return getAxios.delete(`/api/v1/quiz/${id}`)
}
...
export const putUpdateQuizForAdmin = (
  ...
  return getAxios.put("/api/v1/quiz", dataUpdate)
}

export const postAssignQuizForUser = (quizId, userId) => {
  return getAxios.post("/api/v1/quiz-assign-to-user", {
    quizId,
    userId,
  })
}
...
export const getQuizWithQA = (quizId) => {
  return getAxios.get(`/api/v1/quiz-with-qa/${quizId}`)
}

export const postUpsertQA = (data) => {
  return getAxios.post("/api/v1/quiz-upsert-qa", { ...data })
}
...
export const postCreateNewQuestion = (quiz_id, description, questionImage) => {
  ...
  return getAxios.post("/api/v1/question", data)
}
...
export const postCreateNewAnswer = (
  ...
  return getAxios.post("/api/v1/answer", {
    description,
    correct_answer,
    question_id,
  })
